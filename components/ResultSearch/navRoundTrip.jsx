...
const NavHasilPencarianRoundTrip = () => {
  const router = useRouter();
  const { tanggalBerangkat, tanggalPulang, kotaAwal, kotaTujuan } = router.query;
  ...
  const handleDateSelect = (selectedDate) => {
    ...
    router.push({
      pathname: '/hasilPencarian/roundTrip',
      query: { tanggalBerangkat: selectedDate, tanggalPulang: selectedDateReturn, kotaAwal, kotaTujuan },
    });
  };
...
export default NavHasilPencarianRoundTrip;
